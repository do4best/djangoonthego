...
def load_data():
    path = r"D:\onlynodejs\onlyjs\tkinter-excel-app-main\people.xlsx"
...
def insert_row():
    ...
    path = r"D:\codefirst.io\Tkinter Excel App\people.xlsx"
    workbook = openpyxl.load_workbook(path)
    sheet = workbook.active
...
root.tk.call("source", os.path.join(script_dir, "forest-light.tcl"))
root.tk.call("source",os.path.join(script_dir,  "forest-dark.tcl"))
style.theme_use("forest-dark")
